...
Items: Sequence[ItemPool] = (
    ItemPool("Blue Infiltrator / Beast / Banshee / Engineer / Slab / Roboteer / Desperado / CEO / Bloodthirster", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 0, Character.Gladiator),
    ),
    ItemPool("Blue Killer / Berserker / Binder / Grenadier / Meat / Zapper / Law Enforcer / Entrepreneur / Cannoness", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 1, Character.Gladiator),
    ),
    ItemPool("Blue Ninja / War Dog / Cat / Gunner / Crunch / Jill of All Trades / The Kid / Hero / Defender", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 2, Character.Gladiator),
    ),
    ItemPool("Blue Professional / Devastator / Fox / Pointman / Toast / Punk / Six-Shooter / Paragon / Dominator", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 3, Character.Gladiator),
    ),
    ItemPool("Blue Shot / Raider / Matriarch / Rifleman / Torch / Anarchist / Cowgirl / VIP / Dragon", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 4, Character.Gladiator),
    ),
    ItemPool("Blue Sniper / Renegade / Nurse / Shock Trooper / Sickle / Technophile / Rustler / Antagonist / Femme", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 5, Character.Gladiator),
    ),
    ItemPool("Blue Spy / Tank / Trickster / Specialist / Wound / Prodigy / Sheriff / Role Model / Gladiatrix", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 6, Character.Gladiator),
    ),
    ItemPool("Blue Stalker / Titan / Warder / Tactician / Blister / Catalyst / Crapshooter / Protagonist / Protector", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 7, Character.Gladiator),
    ),
    ItemPool("Blue Survivor / Hoarder / Witch / Veteran / Reaper / Sweetheart / Bounty Hunter / Best Man / Storm", Hint.BlueClassMod,
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 8, Character.Gladiator),
    ),
    ItemPool("Blue The Lone Star / Economist / Blademaster", Hint.BlueClassMod,
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Assassin),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mercenary),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Siren),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Soldier),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Psycho),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mechromancer),
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 9, Character.Gladiator),
    ),
    ItemPool("Blue Illusion / Projection / Hologram", Hint.BlueClassMod,
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Assassin),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mercenary),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Siren),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Soldier),
        ...
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_03_Rare", 10, Character.Gladiator),
    ),
    ItemPool("Purple Infiltrator / Beast / Banshee / Engineer / Slab / Roboteer / Desperado / CEO / Bloodthirster", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 0, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 0, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 0, Character.Gladiator),
    ),
    ItemPool("Purple Killer / Berserker / Binder / Grenadier / Meat / Zapper / Law Enforcer / Entrepreneur / Cannoness", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 1, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 1, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 1, Character.Gladiator),
    ),
    ItemPool("Purple Ninja / War Dog / Cat / Gunner / Crunch / Jill of All Trades / The Kid / Hero / Defender", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 2, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 2, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 2, Character.Gladiator),
    ),
    ItemPool("Purple Professional / Devastator / Fox / Pointman / Toast / Punk / Six-Shooter / Paragon / Dominator", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 3, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 3, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 3, Character.Gladiator),
    ),
    ItemPool("Purple Shot / Raider / Matriarch / Rifleman / Torch / Anarchist / Cowgirl / VIP / Dragon", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 4, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 4, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 4, Character.Gladiator),
    ),
    ItemPool("Purple Sniper / Renegade / Nurse / Shock Trooper / Sickle / Technophile / Rustler / Antagonist / Femme", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 5, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 5, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 5, Character.Gladiator),
    ),
    ItemPool("Purple Spy / Tank / Trickster / Specialist / Wound / Prodigy / Sheriff / Role Model / Gladiatrix", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 6, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 6, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 6, Character.Gladiator),
    ),
    ItemPool("Purple Stalker / Titan / Warder / Tactician / Blister / Catalyst / Crapshooter / Protagonist / Protector", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 7, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 7, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 7, Character.Gladiator),
    ),
    ItemPool("Purple Survivor / Hoarder / Witch / Veteran / Reaper / Sweetheart / Bounty Hunter / Best Man / Storm", Hint.PurpleClassMod,
        ...
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 8, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 8, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 8, Character.Gladiator),
    ),
    ItemPool("Purple The Lone Star / Economist / Blademaster", Hint.PurpleClassMod,
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Assassin),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mercenary),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Siren),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Soldier),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Psycho),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mechromancer),
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 9, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 9, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 9, Character.Gladiator),
    ),
    ItemPool("Purple Illusion / Projection / Hologram", Hint.PurpleClassMod,
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Assassin),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mercenary),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Siren),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Soldier),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Psycho),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mechromancer),
        ClassMod("GD_Nisha_ItemGrades.ClassMods.BalDef_ClassMod_Mechromancer_04_VeryRare", 10, Character.Lawbringer),
        ClassMod("GD_Quince_ItemGrades.ClassMods.BalDef_ClassMod_Doppelganger_04_VeryRare", 10, Character.Doppelganger),
        ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_04_VeryRare", 10, Character.Gladiator),
    ),
    ItemPool("Blue Rogue / Monk / Cleric / Ranger / Barbarian / Necromancer / Justicar / Conjurer / Paladin", Hint.BlueClassMod,
        ...
        BlueAlignmentClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Aster_Gladiator", Character.Gladiator, Tag.DragonKeep),
    ),
    ItemPool("Purple Rogue / Monk / Cleric / Ranger / Barbarian / Necromancer / Justicar / Conjurer / Paladin", Hint.PurpleClassMod,
        ...
        PurpleAlignmentClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Aster_Gladiator", Character.Gladiator, Tag.DragonKeep),
    ),
    ItemPool("Legendary Paladin", Hint.LegendaryClassMod,
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Assassin, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mercenary, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Siren, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Soldier, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Psycho, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Mechromancer, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Lawbringer, Tag.DragonKeep),
        Item("LootRandomizer.InvBal_Hint_Dudicated", Character.Doppelganger, Tag.DragonKeep),
        Item("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_06_LegendaryPaladin", Character.Gladiator, Tag.DragonKeep),
    ),
    ItemPool("Legendary Hunter / Berserker / Siren / Soldier / Psycho / Mechromancer / Lawbringer / Doppelganger / Gladiator", Hint.LegendaryClassMod,
    ...
    ItemPool("Slayer Of Terramorphous", Hint.LegendaryClassMod,
        ...
        Item("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_06_EridianVanquisher", Character.Gladiator),
    ),
    ItemPool("Legendary Killer / Gunzerker / Binder / Engineer / Sickle / Anarchist / Cowgirl / Economist / Bloodthirster", Hint.LegendaryClassMod,
        ...
        Gen2ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_07_Chronicler", 0, Character.Gladiator, Tag.DigistructPeak),
    ),
    ItemPool("Legendary Ninja / Hoarder / Cat / Pointman / Torch / Catalyst / Crapshooter / Antagonist / Protector", Hint.LegendaryClassMod,
        ...
        Gen2ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_05_LegendaryProtector", 0, Character.Gladiator, Tag.DigistructPeak),
    ),
    ItemPool("Legendary Sniper / Titan / Nurse / Ranger / Reaper / Roboteer / Desperado / Protagonist / Storm", Hint.LegendaryClassMod,
        ...
        Gen2ClassMod("GD_GladiatorClassMods.BalanceDefs.BalDef_ClassMod_Gladiator_05_LegendaryStorm", 0, Character.Gladiator, Tag.DigistructPeak),
    ),
